...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2016 at 05:29 AM
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `birth_date`, `gender`, `pic`, `id_role`) VALUES
(1, '127.0.0.1', 'administrator', '$2y$08$t7r5eKrqNjI9k5.Z0ntDgOi4zAta5ZkVZsA2pXJ.bjWnecU.POQvC', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1460517471, 1, 'Admin', 'istrator', 'ADMIN', '0', '0000-00-00', 'male', '', 3),
(2, '::1', 'fofo', '$2y$08$sp49JRhjGIu0Y0bpbolEoefwPpGVbX2YDBNsjMQ1UUKAg0n/KiHeG', NULL, 'b.u@gmail.com', NULL, NULL, NULL, NULL, 2016, NULL, 1, 'usama', 'baghdady', 'usamaaaa', '123456789', '2016-04-06', 'male', '', 2),
(3, '11321', 'test', 'testtest', NULL, 'test@gmail.com', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', 'male', '', 2),
(4, '::1', NULL, '$2y$08$KpmTX3ah8PZ9jwEia64.Je.rptasMl9obCz4YaebOJGiCXJkqHq.y', NULL, 'someone@gmail.co', NULL, NULL, NULL, NULL, 1460517179, NULL, 1, '0', '0', '0', '0', '0000-00-00', 'male', '', 2);
