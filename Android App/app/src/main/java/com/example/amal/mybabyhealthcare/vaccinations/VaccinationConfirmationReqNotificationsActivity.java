...
public class VaccinationConfirmationReqNotificationsActivity extends AppCompatActivity {
        ...
        //if(rootView != null && getActivity() != null)
        {
            ...
            notifications_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Intent i = new Intent(VaccinationConfirmationReqNotificationsActivity.this, VaccenationConfirmationReqActivity.class);
            ...
            public void onResponse() {
                if (api.query_status) {
                    if (api.notifications != null) {
                        ...
                        NotificationsListAdapter adapter = new NotificationsListAdapter(VaccinationConfirmationReqNotificationsActivity.this, notifications);
                        notifications_list.setAdapter(adapter);
                    }
                } else Toast.makeText(VaccinationConfirmationReqNotificationsActivity.this, api.message, Toast.LENGTH_LONG).show();
            }
        });
    }
}
