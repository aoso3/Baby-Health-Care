...
public class VaccinationsRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vaccinations_record);
    ...
    void get_records(){
        ...
        ChildSessionManager manager = new ChildSessionManager(VaccinationsRecordActivity.this);
            ...
            api.sendRequest(child_id, new CallBack() {
                ...
                public void onResponse() {
                    if(api.query_status)
                    {
                        ...
                        {
                            record = api.record;
                            VaccinationRecordItemAdapter adapter = new VaccinationRecordItemAdapter(VaccinationsRecordActivity.this, record);
